...
public class GetFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest _request, HttpServletResponse _response)
        ...
        if (fdb != null) {
            ...
            // hace que aparezca el nombre original del fichero cuando se intenta guardar en el 
            // disco local del usuario
            _response.addHeader("Content-Disposition", "attachment;filename=\"" + fdb.getFileName() + "\"");
