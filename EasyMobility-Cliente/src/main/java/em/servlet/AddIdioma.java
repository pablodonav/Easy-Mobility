 ...
 * @author Ususario
 */
@WebServlet(name = "AddIdioma", urlPatterns = {"/addIdioma"})
public class AddIdioma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest _request, HttpServletResponse _response)
        ...
        String idioma = _request.getParameter("languageName");
        HttpSession session = _request.getSession(false);
        
        if (!idioma.isBlank()){
            IdiomaDTO newIdioma = new IdiomaDTO(null, idioma);
            LanguageServiceManager languageServiceManager = LanguageServiceManager.getInstance();
            languageServiceManager.addLanguage(newIdioma, session);
        }else{
            session.setAttribute("errorIdioma", ErrorMessages.ERROR_CAMPOS_INVALIDOS.toString());
        }
