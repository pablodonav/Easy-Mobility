...
public class ServerAcuerdoEstudiosRestService {
    ...
    /**
     * Devuelve los alumnos de un coordinador.
     * 
     * @param <T>
     * @param _responseType
    ...
    /**
     * Encuentra un acuerdo de estudios en concreto.
     * 
     * @param <T>
     * @param _responseType
     * @param _idAcuerdo
    ...
    /**
     * Encuentra un rango de acuerdos.
     * 
     * @param <T>
     * @param _responseType
     * @param _from
    ...
    /**
     * Encuentra los alumnos de un estudio.
     * 
     * @param <T>
     * @param _responseType
     * @param _idCentro
    ...
    /**
     * Devuelve todos los acuerdos de estudios.
     * 
     * @param <T>
     * @param _responseType
     * @return
