...
public class ServerEstudiosRestService {
    ...
    /**
     * Devuelve la cuenta de estudios dados de alta.
     * 
     * @return
    ...
    /**
     * Encuentra un estudio en concreto.
     * 
     * @param <T>
     * @param _responseType
     * @param _idCentro
    ...
    /**
     * Encuentra un estudio por coordinador.
     * 
     * @param <T>
     * @param _responseType
    ...
    /**
     * Encuentra los estudios dentro de un rango.
     * 
     * @param <T>
     * @param _responseType
     * @param _from
    ...
    /**
     * Devuelve una lista de estudios ajenos a un coordinador.
     * 
     * @param <T>
     * @param _responseType
     * @param _numIdentificacion
