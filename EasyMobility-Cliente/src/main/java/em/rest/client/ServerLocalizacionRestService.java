...
public class ServerLocalizacionRestService {
    ...
    /**
     * Devuelve la cuenta de localizaciones dadas de alta.
     * 
     * @return
    ...
    /**
     * Encuentra localizaciones dentro de un rango.
     * 
     * @param <T>
     * @param _responseType
     * @param _from
    ...
    public int create(Object _requestEntity) throws RuntimeException {
        return webTarget.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)
                .post(javax.ws.rs.client.Entity.entity(_requestEntity, javax.ws.rs.core.MediaType.APPLICATION_JSON)).getStatus();
    }
