...
`------' `--`--'`----'.-'  /   `--'   `--' `---'  `---' `--'`--'`--'  `--'  .-'  /    
    ...
    File: ServerCentrosRestService.java
    Date: 06 abr. 2023
...
public class ServerCentrosRestService {
    ...
    /**
     * Construye un ServerCentrosRestService.
     * 
     */
    public ServerCentrosRestService() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("center");
    }
     ...
     * @throws RuntimeException 
     */
    public int edit(Object _requestEntity, String _idCentro, String _idUniversidad) throws RuntimeException {
        return webTarget.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{_idCentro, _idUniversidad}))
     ...
     * @throws RuntimeException 
     */
    public <T> T find(Class<T> _responseType, String _idCentro, String _idUniversidad) throws RuntimeException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("fnd/{0}/{1}", new Object[]{_idCentro, _idUniversidad}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON)
                .get(_responseType);
    }

    /**
     * Encuentra centros dentro de un rango.
     * 
     * @param <T>
     * @param _responseType
     * @param _from
     ...
     * @throws RuntimeException 
     */
    public int remove(String _idCentro, String _idUniversidad) throws RuntimeException {
        return webTarget.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{_idCentro, _idUniversidad}))
                .request()
                .delete()
                .getStatus();
