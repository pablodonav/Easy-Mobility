...
public class ServerCoordinadorRestService {
    ...
    /**
     * Construye un ServerCoordinadorRestService.
     * 
     */
    public ServerCoordinadorRestService() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("coordinator");
    }
    ...
    /**
     * Encuentra un coordinador por su correo.
     * 
     * @param <T>
     * @param _responseType
     * @param _email
    ...
    /**
     * Encuentra coordinadores dentro de un rango.
     * 
     * @param <T>
     * @param _responseType
     * @param _from
