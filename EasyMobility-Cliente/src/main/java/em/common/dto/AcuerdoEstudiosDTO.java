...
public class AcuerdoEstudiosDTO implements Serializable {
     ...
     *
     */
    public AcuerdoEstudiosDTO(Long _idAcuerdo, EstudioDTO _estudioOrigen,
            EstudioDTO _estudioDestino, String _cursoAcademico,
            PeriodoIntercambio _periodoIntercambio, AlumnoDTO _alumno,
            IdiomaDTO _idioma) {
        this.id = _idAcuerdo;
