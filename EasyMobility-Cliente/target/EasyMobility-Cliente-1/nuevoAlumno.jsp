...
<%
    ...
    String randomPwd = studentServiceManager.generateAlumnoPwd(session);
%>
<html lang="en">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="gestionAlumnos.jsp">
                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <h4 class="card-title">Inserción de un alumno nuevo</h4>
                                            </div>
                                        ...
                                        <form class="form-sample" id="regForm" method=POST action="addAlumno">
                                            <div class="tab">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="studentName" name="studentName" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="studentSurname1" name="studentSurname1" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="studentSurname2" name="studentSurname2" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="email" class="form-control" id="studentEmail" name="studentEmail" title="El formato del correo electrónico es: xx@xx.xx" placeholder="example@example.com" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="studentDefaultPassword" name="studentDefaultPassword" value="<%=randomPwd%>" oninput="this.className = 'form-control'" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group" style="width:100%;">
                                                                    <input class="form-control" type="tel" name="phone" id="phone" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="dropdown row">
                                                            <div class="form-group col-5">
                                                                <select class="form-select dropdownlist" id="identificationType" name="identificationType" onchange="this.className = 'form-select dropdownlist'">
                                                                    <option selected disabled value="-1">Selecciona documento de identificación</option>
                                                                    <option value="dni">DNI</option>
                                                                    <option value="pasaporte">Pasaporte</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group col">
                                                                <input type="text" class="form-control" id="studentIdentification" name="studentIdentification" oninput="this.className = 'form-control'">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="country-select" name="countryName" class="form-select dropdownlist" data-live-search="true" style="width: 100%;" onchange="configureDropDownUniversityList(''); this.className = 'form-select dropdownlist';">  
                                                                <option selected disabled value="-1">Selecciona tu país de destino</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="academicYear" name="academicYear" title="El formato del curso académico es: ####-##" placeholder="2020-21" oninput="this.className = 'form-control'">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="languageId" name="languageId" class="form-select dropdownlist" style="width: 100%" onchange = "changeFunc(this.value); this.className = 'form-select dropdownlist';">
                                                                <option selected disabled value="-1">Selecciona el idioma requerido</option>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="addIdiomaButtonInNuevoAlumno" style="background-color:#4B49AC;">Añadir</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
