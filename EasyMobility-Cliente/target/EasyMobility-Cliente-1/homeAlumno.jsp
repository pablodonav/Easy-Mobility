...
<!DOCTYPE html>
<%
    String numIdentificacionAlumno = (String) session.getAttribute("userId");
    ...
    session.setAttribute("userType", "Alumn");
...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <h4 class="card-title">Documentación del usuario: <%=numIdentificacionAlumno%></h4>
                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col col-lg-2">
                                                                <form action="removeFile" method="POST" title="Borrar" data-toggle="tooltip">
                                                                    ...
                                                                    <button style="background: none;border: none;color: #E34724;" type="submit">
        ...
        <script>
            var userId = '<%=numIdentificacionAlumno%>';
            var wsUri = '<%=wsUri%>';
        </script>
