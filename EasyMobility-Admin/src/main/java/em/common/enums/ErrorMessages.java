...
public enum ErrorMessages {
    ...
    ERROR_ADD_COORDINADOR("¡No se ha podido añadir un nuevo coordinador!"),
    ERROR_DELETE_COORDINADOR("¡No se ha podido eliminar el coordinador!"),
    ERROR_COORDINADOR_YA_EXISTE("¡No se ha podido realizar la inserción. Ya existe un coordinador con dicho número de identificación!"),
    ...
    ERROR_ADD_ESTUDIO("¡No se ha podido añadir el estudio!"),
    ...
    /* Mensajes Error Administrador */
    ERROR_OBTENER_ADMINISTRADOR("No se ha podido obtener el administrador indicado"),
    
    /* Mensajes Error Alta Estudio */
    ERROR_ADD_AREA_ESTUDIO("¡No se ha podido realizar la inserción del area de estudio!"),
    ERROR_ADD_UNIVERSIDAD("¡No se ha podido realizar la inserción de la universidad!"),
    ERROR_ADD_CENTRO("¡No se ha podido realizar la inserción del centro!"),
    ERROR_NOMBRE_NULO_INCORRECTO("El nombre del estudio está vacío o es incorrecto."),
    ERROR_AREA_ESTUDIO_NO_SELECCIONADA("Tienes que seleccionar un area de estudio de la lista."),
    ERROR_COORDINADOR_NO_SELECCIONADO("Tienes que seleccionar un coordinador de la lista."),
    ERROR_UNIVERSIDAD_NO_SELECCIONADA("Tienes que seleccionar una universidad de la lista."),
    ERROR_CENTRO_NO_SELECCIONADO("Tienes que seleccionar un centro de la lista."),
    
    /* Mensaje Error Borrado Estudio */
    ERROR_DELETE_ESTUDIO("¡No se ha podido eliminar el estudio!"),
    
    /* Mensaje Error Editar Estudio */
    ERROR_EDITAR_ESTUDIO("¡No se ha podido editar el estudio!");
