...
public class AlumnoDTO extends UsuarioDTO implements Serializable {
     ...
     */
    public AlumnoDTO(String _numIdentificacion, TipoIdentificacion _documentoIdentificacion,
        ...
        super(_numIdentificacion, _documentoIdentificacion, _telefono, _nombre,
                _apellido1, _apellido2, _correo, _hashContrasenya, _haCambiadoPwd);
    }
