                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb" style="border: white;">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">Nuevo coordinador</li>
                                                </ol>
                                            </nav>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                <h4 class="card-title">Inserción de un coordinador nuevo</h4>
                                            </div>
                                        ...
                                        <form class="form-sample" id="regForm" method=POST action="addCoordinador">
                                            <div class="tab">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="coordinatorName" name="coordinatorName" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="coordinatorSurname1" name="coordinatorSurname1" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="coordinatorSurname2" name="coordinatorSurname2" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="email" class="form-control" id="coordinatorEmail" name="coordinatorEmail" title="El formato del correo electrónico es: xx@xx.xx" placeholder="example@example.com" oninput="this.className = 'form-control'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" id="coordinatorDefaultPassword" name="coordinatorDefaultPassword" value="<%=randomPwd%>" oninput="this.className = 'form-control'" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="dropdown row">
                                                            ...
                                                            <div class="form-group col">
                                                                <input type="text" class="form-control" id="coordinatorIdentification" name="coordinatorIdentification" oninput="this.className = 'form-control'">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
