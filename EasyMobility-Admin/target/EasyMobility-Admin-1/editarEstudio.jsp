...
<%
    ...
    String idAreaEstudio;
    String numIdentificacion;
    
    if(session.getAttribute("fromServlet") == "true") {
        idEstudio = (String) session.getAttribute("idEstudio");
        idCentro = (String) session.getAttribute("idCentro");
        idUniversidad = (String) session.getAttribute("idUniversidad");
        idAreaEstudio = (String) session.getAttribute("idAreaEstudio");
        numIdentificacion = (String) session.getAttribute("numIdentificacion");
        session.setAttribute("fromServlet", "false");
    } else {
        idEstudio = request.getParameter("idEstudio");
        idCentro = request.getParameter("idCentro");
        idUniversidad = request.getParameter("idUniversidad");
        idAreaEstudio = request.getParameter("idAreaEstudio");
        numIdentificacion = request.getParameter("numIdentificacion");
    }
    ...
    EstudioDTO estudio = studyServiceManager.getEstudio(idCentro, idUniversidad, idEstudio, session);
                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <h4 class="card-title">Edición de un estudio</h4>
                                            </div>
                                        ...
                                        <form class="form-sample" id="regForm" method=POST action="editEstudio" novalidate>
                                            <input type="hidden" id="idEstudio" name="idEstudio" value="<%=estudio.getId().getIdEstudio()%>">
                                            <input type="hidden" id="idAntiguoCentro" name="idAntiguoCentro" value="<%=estudio.getCentro().getId().getIdCentro()%>">
                                            <input type="hidden" id="idAntiguaUniversidad" name="idAntiguaUniversidad" value="<%=estudio.getCentro().getId().getIdUniversidad()%>">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<%=estudio.getNombreEstudio()%>" class="form-control" id="studyName" name="studyName" oninput="this.className = 'form-control'">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="areaEstudiosId" name="areaEstudiosId" class="form-select dropdownlist" style="width: 100%" onchange = "this.className = 'form-select dropdownlist';">
                                                            <option disabled value="-1">Selecciona el area de estudio requerido</option>
                                                            <% for (AreaEstudiosDTO areaEstudio : areasDeEstudio) { 
                                                                if(areaEstudio.getId() == Long.valueOf(idAreaEstudio)) {
                                                            %>
                                                            <option selected value="<%=areaEstudio.getId()%>"><%=areaEstudio.getNombre()%></option>
                                                            <%} else {%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="university-select" name="university-select" class="form-select dropdownlist" data-live-search="true" style="width: 100%" onchange="configureDropDownCenterList(this.value); this.className = 'form-select dropdownlist';">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="center-select" name="center-select" class="form-select dropdownlist" data-live-search="true" style="width: 100%" onchange="this.className = 'form-select dropdownlist';">
                                            ...
                                            <div style="overflow:auto;">
                                                <div style="float:right;">
                                                    <button type="submit" form="regForm">Editar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
